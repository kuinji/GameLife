...
struct iGame
{
    ...
    virtual void runGame(int numIt, int radius) = 0;
...
struct Game2D : public iGame
{
    ...
    void runGame(int numIt, int radius = 0) override
    {
...
int main()
{
    ...
    // Test 1
    game->originField3D[1][0][1].type = TypeCell::alive;
    game->originField3D[1][2][3].type = TypeCell::alive;
    game->originField3D[2][0][1].type = TypeCell::alive;
    game->originField3D[2][2][2].type = TypeCell::alive;
    game->originField3D[3][2][2].type = TypeCell::alive;
    game->originField3D[3][3][1].type = TypeCell::alive;
    game->testGame(numIt);
    ...
    /*for (int i = 0; i < K; i++)
        for (int j = 0; j < N; j++)
            for (int l = 0; l < M; l++)
                game->originField3D[i][j][l].type = TypeCell::alive;
    game->originField3D[2][0][2].type = TypeCell::env;
    game->originField3D[2][1][0].type = TypeCell::env;
    game->originField3D[3][2][1].type = TypeCell::env;
    game->testGame(numIt);*/
